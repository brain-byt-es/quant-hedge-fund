    ...
    <Card className="h-full border-border/50 bg-card/40 backdrop-blur-md flex flex-col overflow-hidden shadow-2xl">
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-6 custom-scrollbar">
            ...
            <div className="space-y-2 border-t border-border/50 pt-4">
                <span className="text-[9px] text-muted-foreground uppercase font-bold tracking-[0.2em] block">Full Narrative</span>
                <p className="text-[11px] text-muted-foreground leading-relaxed font-serif italic opacity-80">
                    {profile.description}
                </p>
            </div>
